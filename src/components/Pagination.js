    ...
    return (
        pages > 1 && (
            <div className="flex items-center justify-center">
                ...
                >
                    <BackArrow className="fill-[#89909B] mr-7" />
                </button>
                ...
                >
                    <ForwardArrow className="fill-[#89909B] ml-7" />
                </button>
            </div>
        )
    );
...
const PaginationSquare = ({ value, page, onClick }) => {
    return (
        <li
            className={`flex items-center justify-center text-[1.5rem]  font-bold w-[48px] h-[48px] border border-[#B9C0CC] rounded cursor-pointer ${
                value == page
